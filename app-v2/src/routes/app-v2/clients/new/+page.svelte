...
<div class="flex flex-col gap-6">
	<div class="flex flex-wrap items-center gap-2">
		<Button href="/app-v2/clients" variant="ghost" size="icon" class="app-v2-ghost min-h-11 min-w-11">
			<ChevronLeftIcon class="h-5 w-5" aria-hidden="true" />
			<span class="sr-only">Back to clients</span>
		</Button>
		<h1 class="app-v2-display text-3xl md:text-4xl" style="color: var(--app-v2-text);">New client</h1>
	</div>

	<div class="app-v2-card mx-auto w-full max-w-3xl p-6 md:p-8">
		<h2 class="text-lg font-semibold">Client information</h2>
		<p class="mt-1 text-sm" style="color: var(--app-v2-muted);">Enter details for your new client.</p>
		...
		<form onsubmit={handleSubmit} class="mt-6 space-y-4">
			...
			<div class="flex flex-wrap gap-3 pt-4">
				<Button type="submit" class="app-v2-cta min-h-11" disabled={clientMutation.isPending}>
					{clientMutation.isPending ? 'Creating…' : 'Create client'}
				</Button>
				<Button href="/app-v2/clients" variant="outline" type="button" class="app-v2-outline min-h-11">
					Cancel
				</Button>
			</div>
		</form>
