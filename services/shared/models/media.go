...
func (m *Media) ToProto() *v1_entities.Media {
	return &v1_entities.Media{
		...
		// Errors:                 m.Errors.Map(),
		AnglesOfInterestEnum: m.AnglesOfInterestEnum,
		// AnglesOfInterest:       m.AnglesOfInterest.Map(),
		// Landmark2dResults:      m.Landmark2dResults.Map(),
		// Landmark3dResults:      m.Landmark3dResults.Map(),
